...
public class CompletableTask<V> implements Task<V>, Callable<V>, Future<V> {

    public static <V> CompletableTask<V> empty() {
    ...
    public CompletableTask<V> clearResults() {
        this.results.clear();
        return this;
    }

    public CompletableTask<V> addResult(@NotNull TaskResult<V> result) {
        check(result);
		results.add(result);
        return this;
    }
