...
public class FileDocument implements Document {
    ...
    @Override
    public @NotNull Config withoutRelation() {
        return this.config;
    }

    @Override
    public void save(@NotNull Representer representer) throws IOException {
        if (this.relation instanceof WriteableResource) {
            this.save((WriteableResource) this.relation, representer);
            return;
        }
    ...
    public @NotNull ConfigSection getSectionOrEmpty(@NotNull String path) {
        return this.config.getSectionOrEmpty(path);
    }
