...
public class GreaterMatcher implements VersionMatcher {

    private final Version version;

    public GreaterMatcher(@NotNull Version version) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GreaterMatcher)) return false;
        GreaterMatcher other = (GreaterMatcher) object;
