...
public class AtomicsSerializerTest {
    ...
    void serializeAtomicInteger() {
        ...
        assertEquals(AtomicInteger.class.getName(), map.get(NamedSerializers.SERIALIZED_TYPE_KEY));
    }
    ...
    void deserializeAtomicInteger() {
        ...
        map.put(NamedSerializers.SERIALIZED_TYPE_KEY, AtomicInteger.class.getName());
    ...
    void serializeAtomicLong() {
        ...
        assertEquals(AtomicLong.class.getName(), map.get(NamedSerializers.SERIALIZED_TYPE_KEY));
    }
    ...
    void deserializeAtomicLong() {
        ...
        map.put(NamedSerializers.SERIALIZED_TYPE_KEY, AtomicLong.class.getName());
    ...
    void serializeAtomicBoolean() {
        ...
        assertEquals(AtomicBoolean.class.getName(), map.get(NamedSerializers.SERIALIZED_TYPE_KEY));
    }
    ...
    void deserializeAtomicBoolean() {
        ...
        map.put(NamedSerializers.SERIALIZED_TYPE_KEY, AtomicBoolean.class.getName());
    ...
    void deserializeUnsupportedTypeThrows() {
        ...
        Map<String, Object> map = new HashMap<>();
        map.put("value", "x");
        map.put(NamedSerializers.SERIALIZED_TYPE_KEY, String.class.getName());
